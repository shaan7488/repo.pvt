...
<html lang="en-US">
<head>
	<title>WAR Web Service by Shanur</title>
...
<body>
	...
	<ul>
		<li><a href="http://localhost:8080/wwp-1.0.0/webapi/service/hello_shanur">http://localhost:8080/wwp-1.0.0/webapi/service/hello_shanur</a></li>
		...
		<li><a href="http://localhost:8080/wwp-1.0.0/webapi/service/send/rowan">http://localhost:8080/wwp-1.0.0/webapi/service/rowan</a> (Accessible using POST)</li>
                <li><a href="http://localhost:8080/wwp-1.0.0/webapi/service/send/rowan">http://localhost:8080/wwp-1.0.0/webapi/service/shanur</a> (Accessible using POST)</li>
	</ul>
</body>
</html>
